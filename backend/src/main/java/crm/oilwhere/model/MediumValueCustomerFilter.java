...
/**
 * Filters customers based on their monetary value, selecting the middle 70% of customers.
 * <p>
...
public class MediumValueCustomerFilter extends CustomerSegmentFilter {
    ...
    /**
     * Filters the middle 70% of customers based on their total spending.
     * <p>
     * The method calculates the boundaries for the bottom 20% and the top 10% of the customer list
     ...
     * @return a list of {@link CustomerSpending} objects representing the middle 70% of customers
     */
    @Override
